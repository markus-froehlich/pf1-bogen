...
export const CONDITIONS = [
  ...
  { id: 'beschaedigt',   de: 'Beschädigt',      en: 'Broken',       effect: 'de: Waffe −2 Angriff/Schaden; Rüstung/Schild RK-Bonus halbiert; 75% Wert' },
  { id: 'blutung',       de: 'Blutung',         en: 'Bleed',        effect: 'de: Schaden zu Rundenbeginn, bis Heilkunde SG 15 o. Heilzauber' },
  { id: 'koerperlos',    de: 'Körperlos',       en: 'Incorporeal',  effect: 'de: immun geg. nichtmagische Angriffe, 50% Schaden von Magischem' },
